...
GUIAsset::GUIAsset( float width, float height, Texture* texture )
{
  ...
  this->model_assets[GUI_NORMAL] = new ModelAsset( "../assets/models/square.obj", MODEL_ASSET_2D );
  this->model_assets[GUI_NORMAL]->addShader( this->shader );
  this->model_assets[GUI_NORMAL]->setTexture( texture );

  this->model_assets[GUI_HOVER] = new ModelAsset( "../assets/models/square.obj", MODEL_ASSET_2D );
